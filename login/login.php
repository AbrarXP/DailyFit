...
<body class="bg-gradient-primary">
        ...
        <?php
        }else if(isset($_GET['pesan']) && $_GET['pesan'] == 'salah'){
        ?>
            <div class="alert border border-light alert-dismissible fade show" role="alert" style="width: 80vw;
                position:sticky; top:5%; left: 10%; z-index:1000;
                background: rgba(210,0,0,0.6);">
                <strong class="text-light">Username atau password salah !</strong>
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>
        <?php
            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-login-image"><img src="../img/5.png" alt="" style="object-fit:cover;filter: brightness(0.5); width:100%; height:100%"></div>
                            <div class="col-lg-6">
                                <div class="p-5">
